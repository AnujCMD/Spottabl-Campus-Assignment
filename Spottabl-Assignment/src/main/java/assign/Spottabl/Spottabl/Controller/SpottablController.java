package assign.Spottabl.Spottabl.Controller;
...
@RestController
public class SpottablController {
	@GetMapping("/download") 
...
//		v2.FlexUserInvitedFromSpottablUser();
		...
		//for(Service csv:csvDataList) {
			filecontent.append(v1.getCode()).append(",").append(v1.userOnSpottabl()).append(",").append(v1.userInvitedFromSpottabl()).append(",").append(v1.userAcceptedInvite()).append(v1.userInvitedFromSpottablUser()).append("\n");
			filecontent.append(v2.getCode()).append(",").append(v2.flexUserOnSpottabl()).append(",").append(v2.userInvitedFromSpottabl()).append(",").append(v2.userAcceptedInvite()).append(v2.userInvitedFromSpottablUser()).append("\n");
